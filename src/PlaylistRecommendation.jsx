...
function PlaylistRecommendation({ tracks, emotion, genre, userId, onBackClick, isLoggedIn, onRegenerate }) {
    ...
    }, [currentTrackIndex, isPlaying, localTracks]);
    ...
    const regeneratePlaylist = () => {
        ...
        // Stop playing when regenerating
        setIsPlaying(false);
        if (onRegenerate) {
            onRegenerate();
        }
    ...
    const PlayerBar = () => {
        ...
        const currentTrack = localTracks[currentTrackIndex];
        const hasPlayingTrack = currentTrack && (isPlaying || currentTime > 0);
        
        if (!hasPlayingTrack) return null;
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            fontSize: "12px",
                            color: playerTextColor === "white" ? "#aaa" : "#555",
                            whiteSpace: "nowrap",
                            overflow: "hidden",
                            textOverflow: "ellipsis",
                            transition: "color 0.5s ease"
        ...
        return (
            <>
                <div className="playlist-container" style={{
                    ...
                    overflowY: "auto",
                    position: "relative",
                    marginBottom: (isPlaying || currentTime > 0) ? "100px" : "50px" // Add extra margin when player bar is visible
                }}>
                    <div className="playlist-header" style={{
                        ...
                        <button className="back-button" onClick={handleBackToMain} style={{
                            background: "#333",
                            border: "none",
                            padding: "8px 15px",
                            borderRadius: "4px",
                        ...
                        <div className="playlist-title">
                            <h2 style={{margin: "0"}}>Your Liked Songs Playlist</h2>
                        </div>
                        <button className="regenerate-button" onClick={onBackClick} style={{
                            background: "#333",
                            border: "none",
                            padding: "8px 15px",
                            borderRadius: "4px",
        ...
        <>
            <div className="playlist-container" style={{
                ...
                <div className="playlist-header" style={{
                    ...
                    <button className="back-button" onClick={onBackClick} style={{
                        background: "#333",
                        border: "none",
                        padding: "8px 15px",
                        borderRadius: "4px",
